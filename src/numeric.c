...
static const char *const replies[] =
{
  ...
  /* 004 */  [RPL_MYINFO] = "%s %s %s abcdhiklmnopqrstvxzeCDIMORST abkloveIhqx",
  ...
  /* 484 */  [ERR_ISCHANSERVICE] = ":Cannot kill, kick or deop a network service",
  ...
  /* 492 */  [ERR_NOCTCP] = "%s :Can't send CTCPs to target. (+C)",
  ...
  /* 518 */  [ERR_NOINVITE] = "%s :Cannot send INVITEs to this user. (+I)",
